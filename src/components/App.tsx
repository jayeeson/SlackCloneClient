...
// const useClasses = () => {
//   const stylesProps: StylesProps = { sidebar: { width: sidebarWidth } };
//   const [classes, setClasses] = useState(useStyles(stylesProps));
//   setClasses(useStyles(stylesProps));

//   useEffect(() => {
//     const stylesProps: StylesProps = { sidebar: { width: sidebarWidth } };
//     // debounce to happen only after couple ms
//     setClasses(useStyles(stylesProps));
//     // add debouncer so local storage only set after few seconds
...
const App = () => {
  ...
  return (
    <React.Fragment>
      <AppContainer>
        <Grid container xs={12} alignItems="stretch" className={classes.root}>
